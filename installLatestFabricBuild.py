...
parser = OptionParser()
parser.add_option("-i", "--installPath", dest="installPath", help ="Path to extract the zip file", default="~/Dev/Fabric/")
...
def unzip(zipPath, installRoot):
    p = subprocess.Popen(['unzip', zipPath, '-d', installRoot], stdout=subprocess.PIPE)
